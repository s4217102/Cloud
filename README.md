...
**Step 1 — Turn on GitHub Pages (one time only)**
1. Go to this repo on GitHub → **Settings** → **Pages**
2. Under "Build and deployment", set **Source** to "Deploy from a branch"
3. Pick this branch and folder `/ (root)`, then **Save**
4. GitHub gives you a link like `https://yourname.github.io/cloud/` — wait a minute, then open it

**Step 2 — Add it to your Home Screen**
1. Open that link in **Safari** on your iPhone
2. Tap the **Share** button (square with an arrow)
3. Tap **Add to Home Screen** → **Add**
4. You now have a WriteWell app icon on your phone — tap it and it opens full-screen, like a real app
